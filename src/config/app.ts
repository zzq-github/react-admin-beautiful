export const appConfig = {
  name: import.meta.env.VITE_APP_NAME || import.meta.env.VITE_TITLE || 'React Admin Beautiful',
  shortName: import.meta.env.VITE_APP_SHORT_NAME || 'Admin',
  description: import.meta.env.VITE_APP_DESCRIPTION || 'Admin Platform',
  copyright: import.meta.env.VITE_APP_COPYRIGHT || '(c) 2026 React Admin Beautiful',
